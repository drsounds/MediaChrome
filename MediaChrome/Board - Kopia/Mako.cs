...
namespace Board
{
    ...
    public class MakoEngine
    {
        ...
        public object synchronize_data(string uri)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    Jint.Native.JsObject D = new Jint.Native.JsObject(jsonRaw);
        ...
        /// </summary>
        public Jint.JintEngine RuntimeMachine { get; set; }
        /// <summary>
        ...
        public String Preprocess(string input,string argument)
        {
             ...
             * */
            RuntimeMachine.SetParameter("parameter", argument);
            /**
            ...
            RuntimeMachine.DisableSecurity();
